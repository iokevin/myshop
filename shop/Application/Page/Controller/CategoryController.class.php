...
class CategoryController extends SiteController {
    ...
    public function index(){
        ...
        //位置导航
        $crumb = D('Eshop/Category')->loadCrumb($classId);
        //内容处理
        $categoryInfo['content'] = html_out($categoryInfo['content']);
        //查询上级栏目信息
        $parentCategoryInfo = D('Eshop/Category')->getInfo($categoryInfo['parent_id']);
        //获取顶级栏目信息
        $topCategoryInfo = D('Eshop/Category')->getInfo($crumb[0]['class_id']);
        //MEDIA信息
