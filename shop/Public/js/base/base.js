...
(function ($) {
    ...
    $.fn.duxEditor = function (options) {
        var defaults = {
            uploadUrl: rootUrl + 'index.php?m=Eshop&c=AdminUpload&a=editor',
    ...
    $.fn.duxFileUpload = function (options) {
        var defaults = {
            uploadUrl: rootUrl + 'index.php?m=Eshop&c=AdminUpload&a=upload',
            type: '',
            uploadParams: function () {},
            complete: function () {}
        }
	...
	//表单页面处理
        $.fn.duxFormPage = function (options) {
            var defaults = {
                uploadUrl: rootUrl + 'index.php?m=Eshop&c=AdminUpload&a=upload',
                editorUploadUrl: rootUrl + 'index.php?m=Eshop&c=AdminUpload&a=editor',
